...
// let filteredArray = [...newArr]

// let list = document.querySelector('#list')
// let add = document.querySelector('#add')

// function show() {
//     filteredArray.forEach((itemGooods, index) => {
...
//     let input = prompt()
//     filteredArray = []
//     filteredArray = newArr.filter((item) => item.product_name === input)
//     list.innerHTML = ''
//     show()
// }

// search.addEventListener('click', arrayFilter)
...
//     if(myBag.includes(filteredArray[index])){
...
//     list.innerHTML = ''
//     filteredArray.push({ "product_name": "Qadın sutyeni", "product_description": "Destəklənmiş, rahat", "product_price": 65 })
//     show()
// })
...
//     if (flag === 1) {
//         filteredArray.sort((a, b) => a.product_price - b.product_price)
//         flag = true
//         sortPointer.style = 'transform: rotate(90deg);'
//     }
//     else if (flag === true) {
//         filteredArray.sort((a, b) => b.product_price - a.product_price)
//         flag = 1
//         sortPointer.style = 'transform: rotate(-90deg);'
//     }
//     list.innerHTML = ''
...
//---------------------------------------------------------------------------------------------------------
// zadaca 2 cast 1 -2duyme ile sekili deyismek


// let one = document.querySelector('#one')
// let two = document.querySelector('#two')
// let myImage = document.querySelector('#myImage')
// myImage.src = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLAl_nto10by7dBsTI0hzY7tRlWXmAxptkF8QCwGd3TELq1MADuP0yKDdXs-DHc2DlZnU&usqp=CAU'
...
//     myImage.src = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS8XZdbcM6yKK4fk9fIJE07OVXK_RjOBgXY67iibHK7zDdPp638HArpPmtfkGTSJhT5vcM&usqp=CAU'
...
//---------------------------------------------------------------------------------------------------------
// zadaca 2 cast 2 --animasiyani elave etdik --catdirmirdi deye animasiyani sekili elaveni vaxtla etdik
...
one.addEventListener('click', function () {
    ...
    myImage.classList.remove('image')
